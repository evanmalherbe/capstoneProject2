...
if (hasRun == false || hasRun == undefined || hasRun == null) {
    ...
    let product1 = new productObj("Grapes", 19.95, "images/grapes.jpg");
    let product2 = new productObj("Laptop", 8995, "images/laptop.jpg");
    let product3 = new productObj("Milk", 20, "images/milk.jpg");
    let product4 = new productObj("Olive oil", 99, "images/olive-oil.jpg");
    let product5 = new productObj("Computer screen", 3995, "images/screen.jpg");
